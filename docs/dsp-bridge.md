...
- **What is the expected latency?**  
    The latency can be adjusted, a latency of one block is the preferred setting. A zero latency mode exists also, but is not recommended. For details, see [Information About Latency](#information-about-latency). 
